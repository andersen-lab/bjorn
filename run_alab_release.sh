...
# DEV RUN
python3 src/alab_release.py --min-coverage 95 --not-dry-run --include-bams --out-dir /valhalla/demo/release --sample-sheet /home/al/analysis/alab_release/SARS-CoV-2_sequence_tracker-GISAID.csv --cpus 25 --analysis-folder /valhalla/analysis --output-metadata /home/al/code/HCoV-19-Genomics/metadata.csv
# REAL RUN
