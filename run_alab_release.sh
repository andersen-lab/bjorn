...
# REAL RUN
python3 src/alab_release.py --min-coverage 95 --min-depth 1000 --not-dry-run --include-bams --out-dir /home/kramesh/test_release --sample-sheet /home/kramesh/test_release/metadata.csv --cpus 25 --analysis-folder /home/kramesh/test_analysis --output-metadata /home/kramesh/HCoV-19-Genomics/metadata.csv
